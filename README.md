...
## attributes
  ...
  * **`outer-input-element`**, HTMLInputElement reference, path any input from outer scope.
  * **`extFormControl`**, AbstructControl, path your own FormControl object, can be used with outer-input-element.
